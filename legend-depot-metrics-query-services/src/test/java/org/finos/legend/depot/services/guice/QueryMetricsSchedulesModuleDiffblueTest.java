...
class QueryMetricsSchedulesModuleDiffblueTest {
  /**
   * Test {@link QueryMetricsSchedulesModule#scheduleMetricsPersistence(SchedulesFactory, QueryMetricsRegistry, QueryMetricsService)}.
   * <p>
   * Method under test: {@link QueryMetricsSchedulesModule#scheduleMetricsPersistence(SchedulesFactory, QueryMetricsRegistry, QueryMetricsService)}
   */
  @Test
  @DisplayName("Test scheduleMetricsPersistence(SchedulesFactory, QueryMetricsRegistry, QueryMetricsService)")
  ...
  void testScheduleMetricsPersistence() {
    ...
    // Act
    boolean actualScheduleMetricsPersistenceResult = queryMetricsSchedulesModule.scheduleMetricsPersistence(
        schedulesFactory, metricsRegistry,
    ...
    // Assert
    verify(schedulesFactory).register(eq("persist-query-metrics"), eq(6000L), eq(30000L), isA(Supplier.class));
