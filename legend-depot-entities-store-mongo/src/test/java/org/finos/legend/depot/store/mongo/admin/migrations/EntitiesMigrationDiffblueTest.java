...
class EntitiesMigrationDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link EntitiesMigration#versionedEntitiesDeletion()}
   */
  @Test
  @DisplayName("Test versionedEntitiesDeletion(); then calls getDeletedCount()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"com.mongodb.client.result.DeleteResult EntitiesMigration.versionedEntitiesDeletion()"})
  void testVersionedEntitiesDeletion_thenCallsGetDeletedCount() {
    ...
    // Act
    new EntitiesMigration(new MongoDatabaseImpl("Name", codecRegistry, readPreference, writeConcern, true, true,
        new ReadConcern(ReadConcernLevel.LOCAL), UuidRepresentation.UNSPECIFIED, executor)).versionedEntitiesDeletion();
   ...
   * </ul>
   * <p>
   * Method under test: {@link EntitiesMigration#entitiesToStoredEntityDataMigration()}
   */
  @Test
