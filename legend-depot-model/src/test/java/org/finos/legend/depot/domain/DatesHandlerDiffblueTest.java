...
class DatesHandlerDiffblueTest {
   ...
   * <ul>
   *   <li>Then return toLocalTime toString is {@code 01:00}.</li>
   * </ul>
   * <p>
   ...
   *   <li>Then return toLocalTime toString is {@code 06:36:40.301}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DatesHandler#parseDate(String)}
   */
  @Test
  @DisplayName("Test parseDate(String); when '20200301'; then return toLocalTime toString is '06:36:40.301'")
  @Tag("MaintainedByDiffblue")
