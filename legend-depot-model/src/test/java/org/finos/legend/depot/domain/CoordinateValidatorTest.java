...
{
    @Test
    public void testValidArtifactId()
    {
        Assertions.assertTrue(CoordinateValidator.isValidArtifactId("legend-depot"));
        Assertions.assertTrue(CoordinateValidator.isValidArtifactId("legend"));
        Assertions.assertTrue(CoordinateValidator.isValidArtifactId("abc123"));
    ...
    public void testInvalidArtifactId()
    {
        ...
        Assertions.assertFalse(CoordinateValidator.isValidArtifactId("Legend-Depot"));
    ...
    public void testValidGroupId()
    {
        ...
        Assertions.assertTrue(CoordinateValidator.isValidGroupId("org"));
    ...
    public void testInvalidGroupId()
    {
        ...
        Assertions.assertFalse(CoordinateValidator.isValidGroupId(".invalid"));
    }
}
