...
public class CoordinateDataTest
{
    ...
    {
        TestCoordinateData data = new TestCoordinateData("org.finos", "legend-depot");
    ...
    {
        TestCoordinateData data1 = new TestCoordinateData("org.finos", "legend-depot");
        TestCoordinateData data2 = new TestCoordinateData("org.finos", "legend-depot");
    ...
    {
        TestCoordinateData data1 = new TestCoordinateData("org.finos", "legend-depot");
        TestCoordinateData data2 = new TestCoordinateData("org.finos", "other-artifact");
