...
class TestInfoResource
{
    ...
    private final InfoResource resource = new InfoResource(infoService, null);

    @Test
    void canGetServerInfo()
    {
    ...
    @Test
    void canGetServerConfig() throws JsonProcessingException
    {
        String config = resource.getServerConfig();

        Assertions.assertEquals("null", config);
    }
}
