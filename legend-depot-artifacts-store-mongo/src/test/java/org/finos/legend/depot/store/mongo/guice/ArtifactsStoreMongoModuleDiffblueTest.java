...
class ArtifactsStoreMongoModuleDiffblueTest {
  /**
   * Test {@link ArtifactsStoreMongoModule#registerIndexes(MongoAdminStore)}.
   *
   * <ul>
   *   <li>Then calls {@link MongoAdminStore#registerIndexes(String, List)}.
   * </ul>
   *
   * <p>Method under test: {@link ArtifactsStoreMongoModule#registerIndexes(MongoAdminStore)}
   */
  @Test
  ...
  void testRegisterIndexes_thenCallsRegisterIndexes() {
    // Arrange
    ArtifactsStoreMongoModule artifactsStoreMongoModule = new ArtifactsStoreMongoModule();
    ...
    // Act
    boolean actualRegisterIndexesResult = artifactsStoreMongoModule.registerIndexes(adminStore);

    // Assert
    verify(adminStore).registerIndexes(eq("artifacts-files"), isA(List.class));
  ...
  void testRegisterIndexes_whenMongoAdminStoreWithMongoDatabaseIsNull_thenReturnTrue() {
    ...
    boolean actualRegisterIndexesResult =
        artifactsStoreMongoModule.registerIndexes(new MongoAdminStore(null));
