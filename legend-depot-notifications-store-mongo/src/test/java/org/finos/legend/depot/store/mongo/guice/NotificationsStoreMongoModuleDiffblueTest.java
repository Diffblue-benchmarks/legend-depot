...
class NotificationsStoreMongoModuleDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link NotificationsStoreMongoModule#registerIndexes(MongoAdminStore)}
   */
  @Test
  ...
  void testRegisterIndexes_thenCallsRegisterIndexes() {
    // Arrange
    NotificationsStoreMongoModule notificationsStoreMongoModule =
  ...
  void testRegisterIndexes_whenMongoAdminStoreWithMongoDatabaseIsNull_thenReturnTrue() {
    ...
    boolean actualRegisterIndexesResult =
        notificationsStoreMongoModule.registerIndexes(new MongoAdminStore(null));
