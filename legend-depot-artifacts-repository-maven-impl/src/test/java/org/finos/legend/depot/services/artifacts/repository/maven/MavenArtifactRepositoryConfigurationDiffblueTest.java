...
class MavenArtifactRepositoryConfigurationDiffblueTest {
  ...
  @MethodsUnderTest({"void MavenArtifactRepositoryConfiguration.<init>(String)",
      "String MavenArtifactRepositoryConfiguration.getSettingsLocation()",
      "String MavenArtifactRepositoryConfiguration.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    MavenArtifactRepositoryConfiguration actualMavenArtifactRepositoryConfiguration = new MavenArtifactRepositoryConfiguration(
        "Settings Location");
    String actualToStringResult = actualMavenArtifactRepositoryConfiguration.toString();
    String actualSettingsLocation = actualMavenArtifactRepositoryConfiguration.getSettingsLocation();

    // Assert
    assertEquals("MavenArtifactRepositoryConfiguration", actualMavenArtifactRepositoryConfiguration.getName());
    assertEquals("MavenArtifactRepositoryConfiguration{name='MavenArtifactRepositoryConfiguration'settings='Settings"
        + " Location'}", actualToStringResult);
