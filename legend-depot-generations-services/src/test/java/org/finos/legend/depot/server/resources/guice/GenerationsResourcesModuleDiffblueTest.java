...
class GenerationsResourcesModuleDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link GenerationsResourcesModule#registerResourceMetrics(PrometheusMetricsHandler)}
   */
  @Test
  ...
  @MethodsUnderTest({"boolean GenerationsResourcesModule.registerResourceMetrics(PrometheusMetricsHandler)"})
