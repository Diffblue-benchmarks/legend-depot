...
public class TestScheduleInstance
{
    ...
    public void testConstructorWithNameAndExpires()
    {
        ...
        ScheduleInstance instance = new ScheduleInstance("my-schedule", expires);
    ...
    public void testIsExpiredReturnsFalseForFutureDate()
    {
        ...
        ScheduleInstance instance = new ScheduleInstance("schedule", future);
    ...
    public void testIsExpiredReturnsTrueForPastDate()
    {
        ...
        ScheduleInstance instance = new ScheduleInstance("schedule", past);
    ...
    public void testSettersAndGetters()
    {
        ScheduleInstance instance = new ScheduleInstance();
        instance.setId("id-1");
        instance.setSchedule("test-schedule");
