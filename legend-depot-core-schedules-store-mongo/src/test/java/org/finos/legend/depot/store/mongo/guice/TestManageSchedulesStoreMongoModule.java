...
class TestManageSchedulesStoreMongoModule extends TestStoreMongo
{
    private final MongoAdminStore adminStore = new MongoAdminStore(mongoProvider);
    private final ManageSchedulesStoreMongoModule module = new ManageSchedulesStoreMongoModule();
