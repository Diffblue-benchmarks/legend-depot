...
class ManageSchedulesStoreMongoModuleDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link ManageSchedulesStoreMongoModule#registerIndexes(MongoAdminStore)}
   */
  @Test
  ...
  void testRegisterIndexes_thenCallsRegisterIndexes() {
    // Arrange
    ManageSchedulesStoreMongoModule manageSchedulesStoreMongoModule =
    ...
    boolean actualRegisterIndexesResult =
        manageSchedulesStoreMongoModule.registerIndexes(adminStore);
  ...
  void testRegisterIndexes_whenMongoAdminStoreWithMongoDatabaseIsNull_thenReturnTrue() {
    ...
    // Act
    boolean actualRegisterIndexesResult =
        manageSchedulesStoreMongoModule.registerIndexes(new MongoAdminStore(null));
