...
public class TestEntitiesResourcesModule
{
    ...
    public void canRegisterResourceMetrics()
    {
        ...
        verify(metricsHandler, times(1)).registerResourceSummaries(EntitiesResource.class);
        verify(metricsHandler, times(1)).registerResourceSummaries(EntitiesDependenciesResource.class);
        verify(metricsHandler, times(1)).registerResourceSummaries(EntityClassifierResource.class);
    }
}
