...
public class TestManageVersionedEntitiesServiceImpl
{
    @Test
    public void canCreateInstance()
    {
        ...
        ManageVersionedEntitiesServiceImpl service = new ManageVersionedEntitiesServiceImpl(entities, projects);
