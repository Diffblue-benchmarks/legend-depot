...
class TestVoidArtifactRepositoryConfiguration
{
    @Test
    ...
    @Test
    void canInitialiseArtifactRepositoryProviderReturnsNull()
    {
        VoidArtifactRepositoryConfiguration config = new VoidArtifactRepositoryConfiguration();

        ArtifactRepository result = config.initialiseArtifactRepositoryProvider();
