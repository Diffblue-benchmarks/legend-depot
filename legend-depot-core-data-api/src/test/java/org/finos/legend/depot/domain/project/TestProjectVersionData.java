...
public class TestProjectVersionData
{
    ...
    @Test
    public void testAddDuplicateDependencyIsIgnored()
    {
        ProjectVersionData data = new ProjectVersionData();
        ProjectVersion dep = new ProjectVersion("org.finos", "artifact", "1.0.0");
        data.addDependency(dep);
    ...
    {
        ProjectVersionData data = new ProjectVersionData();
        ProjectVersion dep1 = new ProjectVersion("org.finos", "artifact-a", "1.0.0");
        ProjectVersion dep2 = new ProjectVersion("org.finos", "artifact-b", "2.0.0");
    ...
    @Test
    public void testAddPropertiesSkipsDuplicates()
    {
        ProjectVersionData data = new ProjectVersionData();
        Property prop = new Property("key", "value");
        data.addProperties(Arrays.asList(prop));
        data.addProperties(Arrays.asList(prop));
    ...
    @Test
    public void testAddDistinctProperties()
    {
        ProjectVersionData data = new ProjectVersionData();
    ...
    @Test
    public void testDeprecatedFlag()
    {
        ProjectVersionData data = new ProjectVersionData();
    ...
    @Test
    public void testExclusionReason()
    {
        ProjectVersionData data = new ProjectVersionData();
    ...
    public void testManifestProperties()
    {
        ...
        manifest.put("Build-Version", "1.0");
        data.setManifestProperties(manifest);
        Assertions.assertEquals("1.0", data.getManifestProperties().get("Build-Version"));
    }
    ...
    @Test
    public void testConstructorWithDeprecatedAndExcluded()
    {
        ProjectVersionData data = new ProjectVersionData(
