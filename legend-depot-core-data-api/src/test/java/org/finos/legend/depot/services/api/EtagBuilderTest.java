...
{
    @Test
    public void testBuildWithReleaseVersion()
    {
        String etag = EtagBuilder.create()
                .withGAV("org.finos", "legend-depot", "1.0.0")
                .build();
        Assertions.assertNotNull(etag);
        Assertions.assertEquals("org.finoslegend-depot1.0.0", etag);
    }
    ...
    {
        String etag = EtagBuilder.create()
                .withGAV("org.finos", "legend-depot", "master-SNAPSHOT")
                .build();
    ...
    {
        String etag = EtagBuilder.create()
                .withGAV("org.finos", "legend-depot", "latest")
                .build();
        Assertions.assertNull(etag);
    }
    ...
    {
        String etag = EtagBuilder.create()
                .withGAV("org.finos", "legend-depot", "head")
                .build();
        Assertions.assertNull(etag);
    }
    ...
    public void testBuildWithProtocolVersion()
    {
        String etag = EtagBuilder.create()
                ...
                .build();
        Assertions.assertNotNull(etag);
        Assertions.assertTrue(etag.contains("v1_0_0"));
    }
