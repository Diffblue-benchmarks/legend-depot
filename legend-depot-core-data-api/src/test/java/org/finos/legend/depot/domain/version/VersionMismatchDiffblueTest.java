...
class VersionMismatchDiffblueTest {
  ...
  void testNewVersionMismatch_givenFoo_thenReturnVersionsNotInStoreIsArrayList2() {
    ...
    // Assert
    assertEquals("\"finance-risk-model\"", actualVersionMismatch.projectId);
    assertEquals("\"legend-depot-artifact\"", actualVersionMismatch.artifactId);
   ...
   *   <li>Then return {@link VersionMismatch#projectId} is {@code "finance-risk-model"}.
   * </ul>
   *
   * <p>Method under test: {@link VersionMismatch#VersionMismatch(String, String, String, List,
   * List, List)}
  ...
  @Test
  @DisplayName(
      "Test new VersionMismatch(String, String, String, List, List, List); when ArrayList(); then return projectId is '\"finance-risk-model\"'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void VersionMismatch.<init>(String, String, String, List, List, List)"})
  void testNewVersionMismatch_whenArrayList_thenReturnProjectIdIsFinanceRiskModel() {
    // Arrange
    ArrayList<String> versionsNotInCache = new ArrayList<>();
    ArrayList<String> versionsNotInRepo = new ArrayList<>();
