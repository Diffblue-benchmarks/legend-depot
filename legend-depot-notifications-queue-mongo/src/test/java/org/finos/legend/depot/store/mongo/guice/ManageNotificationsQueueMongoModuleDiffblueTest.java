...
class ManageNotificationsQueueMongoModuleDiffblueTest {
   ...
   * ManageNotificationsQueueMongoModule#registerIndexes(MongoAdminStore)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean ManageNotificationsQueueMongoModule.registerIndexes(MongoAdminStore)"
  })
  void testRegisterIndexes_thenCallsRegisterIndexes() {
    // Arrange
    ManageNotificationsQueueMongoModule manageNotificationsQueueMongoModule =
    ...
    boolean actualRegisterIndexesResult =
        manageNotificationsQueueMongoModule.registerIndexes(adminStore);
  ...
  void testRegisterIndexes_whenMongoAdminStoreWithMongoDatabaseIsNull_thenReturnTrue() {
    ...
    // Act
    boolean actualRegisterIndexesResult =
        manageNotificationsQueueMongoModule.registerIndexes(new MongoAdminStore(null));
