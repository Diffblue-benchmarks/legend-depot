...
public class VoidPrometheusMetricsHandlerTest
{
    ...
    {
        Assertions.assertDoesNotThrow(() -> handler.observe("summary", 100L, 200L));
    }
    ...
    {
        Assertions.assertDoesNotThrow(() -> handler.registerGauge("gauge", "help", Collections.singletonList("label")));
    }
    ...
    {
        Assertions.assertDoesNotThrow(() -> handler.registerHistogram("histogram", "help", Collections.singletonList("label")));
    }

    @Test
    public void testObserveHistogramDoesNotThrow()
    {
        Assertions.assertDoesNotThrow(() -> handler.observeHistogram("histogram", 100L, 200L));
    }

    @Test
    public void testObserveHistogramWithLabelsDoesNotThrow()
    {
        Assertions.assertDoesNotThrow(() -> handler.observeHistogram("histogram", 100L, 200L, "label1"));
    }

    @Test
    public void testObserveHistogramAmountDoesNotThrow()
    {
        Assertions.assertDoesNotThrow(() -> handler.observeHistogram("histogram", 42.0));
    }
}
