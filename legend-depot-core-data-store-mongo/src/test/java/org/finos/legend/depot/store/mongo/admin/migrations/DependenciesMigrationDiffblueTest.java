...
class DependenciesMigrationDiffblueTest {
   ...
   * DependenciesMigration#calculateTransitiveDependenciesForAllProjectVersions()}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DependenciesMigration.calculateTransitiveDependenciesForAllProjectVersions()"
  })
  void testCalculateTransitiveDependenciesForAllProjectVersions() {
    // Arrange
    MongoCollection<Document> mongoCollection = mock(MongoCollection.class);
    doThrow(new IllegalStateException()).when(mongoCollection).drop();
    ...
    assertThrows(
        ...
        () ->
            new DependenciesMigration(mongoDatabase)
                .calculateTransitiveDependenciesForAllProjectVersions());
  ...
  void testCalculateTransitiveDependenciesForAllProjectVersions3() {
    // Arrange
    FindIterable<Document> findIterable = mock(FindIterable.class);
   ...
   *
   * <p>Method under test: {@link DependenciesMigration#addTransitiveDependenciesToVersionData()}
   */
  @Test
  @DisplayName("Test addTransitiveDependenciesToVersionData()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DependenciesMigration.addTransitiveDependenciesToVersionData()"})
  void testAddTransitiveDependenciesToVersionData() {
    // Arrange
    MongoCollection<Document> mongoCollection = mock(MongoCollection.class);
    when(mongoCollection.find()).thenThrow(new IllegalStateException());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DependenciesMigration.addTransitiveDependenciesToVersionData()"})
  void testAddTransitiveDependenciesToVersionData2() {
    // Arrange
    FindIterable<Document> findIterable = mock(FindIterable.class);
    doThrow(new IllegalStateException())
        .when(findIterable)
  ...
  @Test
  @DisplayName(
      "Test addTransitiveDependenciesToVersionData(); given FindIterable forEach(Consumer) does nothing")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DependenciesMigration.addTransitiveDependenciesToVersionData()"})
  void testAddTransitiveDependenciesToVersionData_givenFindIterableForEachDoesNothing() {
    // Arrange
    FindIterable<Document> findIterable = mock(FindIterable.class);
    doNothing().when(findIterable).forEach(Mockito.<Consumer<Document>>any());
