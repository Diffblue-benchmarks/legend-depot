...
class CoreDataMigrationsDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link CoreDataMigrations#migrationToProjectVersions()}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link CoreDataMigrations#cleanUpProjectData()}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link CoreDataMigrations#calculateTransitiveDependenciesForAllProjectVersions()}
   */
  @Test
  @DisplayName("Test calculateTransitiveDependenciesForAllProjectVersions(); then calls drop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CoreDataMigrations.calculateTransitiveDependenciesForAllProjectVersions()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link CoreDataMigrations#addTransitiveDependenciesToVersionData()}
   */
  @Test
   ...
   * </ul>
   * <p>
   * Method under test: {@link CoreDataMigrations#addLatestVersionToProjectData()}
   */
  @Test
