...
public class TestSchedulesModule
{
    ...
    public void canGetFactory()
    {
        ...
        SchedulesStore schedulesStore = Mockito.mock(SchedulesStore.class);
        ScheduleInstancesStore instancesStore = Mockito.mock(ScheduleInstancesStore.class);
    ...
    @Test
    public void initialiseHouseKeeperReturnsFalse()
    {
        SchedulesModule module = new SchedulesModule();
