...
class ProjectsResourceDiffblueTest {
  /**
   * Test ProjectVersionProperty {@link ProjectVersionProperty#equals(Object)}, and {@link ProjectVersionProperty#hashCode()}.
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty equals(Object), and hashCode(); when other is equal; then return equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ProjectVersionProperty.equals(Object)", "int ProjectVersionProperty.hashCode()"})
  void testProjectVersionPropertyEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    ProjectVersionProperty projectVersionProperty = new ProjectVersionProperty("Property Name", "42", "42");
    ProjectVersionProperty projectVersionProperty2 = new ProjectVersionProperty("Property Name", "42", "42");
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty equals(Object), and hashCode(); when other is same; then return equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ProjectVersionProperty.equals(Object)", "int ProjectVersionProperty.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ProjectVersionProperty#equals(Object)}
   */
  @Test
  @DisplayName("Test ProjectVersionProperty equals(Object); when other is different; then return not equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ProjectVersionProperty.equals(Object)", "int ProjectVersionProperty.hashCode()"})
  void testProjectVersionPropertyEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(projectVersionProperty, new ProjectVersionProperty("Property Name", "42", "42"));
  }
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty equals(Object); when other is 'null'; then return not equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ProjectVersionProperty.equals(Object)", "int ProjectVersionProperty.hashCode()"})
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty equals(Object); when other is wrong type; then return not equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean ProjectVersionProperty.equals(Object)", "int ProjectVersionProperty.hashCode()"})
  void testProjectVersionPropertyEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new ProjectVersionProperty("Property Name", "42", "42"),
   ...
   * <ul>
   *   <li>Then return ProjectVersionId is {@code 42}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty getters and setters; then return ProjectVersionId is '42'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ProjectVersionProperty.<init>()",
      "void ProjectVersionProperty.<init>(String, String, String)",
      "String ProjectVersionProperty.getProjectVersionId()", "String ProjectVersionProperty.getPropertyName()",
      "String ProjectVersionProperty.getValue()"})
  void testProjectVersionPropertyGettersAndSetters_thenReturnProjectVersionIdIs42() {
    // Arrange and Act
    ProjectVersionProperty actualProjectVersionProperty = new ProjectVersionProperty("Property Name", "42", "42");
   ...
   * Test ProjectVersionProperty getters and setters.
   * <ul>
   *   <li>Then return ProjectVersionId is {@code null}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test ProjectVersionProperty getters and setters; then return ProjectVersionId is 'null'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ProjectVersionProperty.<init>()",
      "void ProjectVersionProperty.<init>(String, String, String)",
      "String ProjectVersionProperty.getProjectVersionId()", "String ProjectVersionProperty.getPropertyName()",
