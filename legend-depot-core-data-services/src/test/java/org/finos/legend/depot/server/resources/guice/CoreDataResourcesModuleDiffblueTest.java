...
class CoreDataResourcesModuleDiffblueTest {
   ...
   * CoreDataResourcesModule#registerResourceMetrics(PrometheusMetricsHandler)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CoreDataResourcesModule.registerResourceMetrics(PrometheusMetricsHandler)"
  })
